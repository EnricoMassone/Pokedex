...
public sealed class ShakespearePokemonDescriptionTranslationStrategy : Strategy<Pokemon, TranslatedDescription>
{
  ...
  public ShakespearePokemonDescriptionTranslationStrategy(
    IFunTranslationsApiHttpClient httpClient,
    ILogger<ShakespearePokemonDescriptionTranslationStrategy> logger)
  {
  ...
  protected override async Task<TranslatedDescription> ComputeResultAsync(
    Pokemon data,
    CancellationToken cancellationToken)
  {
    ...
    var translationResult = await _httpClient.ApplyShakespeareTranslationAsync(
