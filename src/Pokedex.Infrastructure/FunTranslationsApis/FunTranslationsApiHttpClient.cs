...
{
  private static readonly Uri ShakespeareEndpointUri = new Uri("shakespeare", UriKind.Relative);
  private static readonly Uri YodaEndpointUri = new Uri("yoda", UriKind.Relative);
